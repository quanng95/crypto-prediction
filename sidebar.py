...
def render_sidebar():
    ...
    # Container cho toggle buttons và backdrop
    ...
    # Render sidebar với fragment để real-time update
    @st.fragment(run_every="0.5s")
    def sidebar_content():
        """Real-time sidebar content"""
        ...
        sidebar_html = f"""
        <div class="sidebar-backdrop {backdrop_class}"></div>
        ...
        if 'ws_handler' in st.session_state:
            ...
            for symbol in symbols:
                ...
                if ticker_data:
                    ...
                    sidebar_html += f"""
                    <div class="sidebar-ticker {selected_class}">
